...
To have the random number be between 20 and 120, the solution uses the
function randomBetween. It takes a min and a max value as arguments.
...
the current value so that the number returned falls within the
range of the arguments passed.

Finally, the Math.floor() method turns the generated number into an
integer.
